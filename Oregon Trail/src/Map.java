...
public class Map<T> {
	...
	private void createLocations() {
		...
		locations[1]  = new Location("Kansas River Crossing", 100, null, "river");
		locations[2]  = new Location("Big Blue River Crossing", 225, null, "river");
		...
		locations[8]  = new Location("Green River", 1025, null, "river");
		locations[9]  = new Location("Soda Springs", 1170);
		locations[10] = new Location("Fort Hall", 1225, new Shop());
		locations[11] = new Location("Snake River Crossing", 1410, null, "river");
