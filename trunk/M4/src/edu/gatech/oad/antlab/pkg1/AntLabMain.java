 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Thomas Cornish");
		  toPrint += p1.toString("902559447");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Jesten Mann");
		  toPrint += p2.toString("902592050");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Kurtis Eveleigh");
          ...
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Stefan Koshy");
          toPrint += p5.toString("902747462");
